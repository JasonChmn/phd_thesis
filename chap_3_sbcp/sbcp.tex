...
We now evaluate on the wall scenario what kind of additional constraints LEAS can learn from the contact planner. In the wall scenario, LEAS has to generate a collision-free guide path ($\tilde{\mathcal{C}}$).
